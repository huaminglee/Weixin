...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_shop_product dal=new MxWeiXinPF.DAL.wx_shop_product();
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_shop_product> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_shop_product> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_shop_product> modelList = new List<MxWeiXinPF.Model.wx_shop_product>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_shop_product model;
