...
namespace MxWeiXinPF.BLL
{
	...
	{
		private readonly MxWeiXinPF.DAL.wx_diancai_member dal=new MxWeiXinPF.DAL.wx_diancai_member();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(MxWeiXinPF.Model.wx_diancai_member model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_diancai_member model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_member GetModel(int id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_diancai_member> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MxWeiXinPF.Model.wx_diancai_member> DataTableToList(DataTable dt)
		{
			List<MxWeiXinPF.Model.wx_diancai_member> modelList = new List<MxWeiXinPF.Model.wx_diancai_member>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MxWeiXinPF.Model.wx_diancai_member model;
