...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_shop_catalog
	{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_shop_catalog model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_shop_catalog GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_shop_catalog model=new MxWeiXinPF.Model.wx_shop_catalog();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_shop_catalog DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_shop_catalog model=new MxWeiXinPF.Model.wx_shop_catalog();
			if (row != null)
			{
