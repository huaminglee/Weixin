...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_dingdan_manage
	{
		...
		public MxWeiXinPF.Model.wx_diancai_dingdan_manage GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_diancai_dingdan_manage model=new MxWeiXinPF.Model.wx_diancai_dingdan_manage();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_dingdan_manage DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_diancai_dingdan_manage model=new MxWeiXinPF.Model.wx_diancai_dingdan_manage();
			if (row != null)
			{
