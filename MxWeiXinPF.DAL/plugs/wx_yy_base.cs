...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_yy_base
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_yy_base model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_yy_base model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_yy_base GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_yy_base model=new MxWeiXinPF.Model.wx_yy_base();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_yy_base DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_yy_base model=new MxWeiXinPF.Model.wx_yy_base();
			if (row != null)
			{
