...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_shop_advertisement
	{
		...
		public MxWeiXinPF.Model.wx_diancai_shop_advertisement GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_diancai_shop_advertisement model=new MxWeiXinPF.Model.wx_diancai_shop_advertisement();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_shop_advertisement DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_diancai_shop_advertisement model=new MxWeiXinPF.Model.wx_diancai_shop_advertisement();
			if (row != null)
			{
