...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_caipin_manage
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_diancai_caipin_manage model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_diancai_caipin_manage model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_caipin_manage GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_diancai_caipin_manage model=new MxWeiXinPF.Model.wx_diancai_caipin_manage();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_diancai_caipin_manage DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_diancai_caipin_manage model=new MxWeiXinPF.Model.wx_diancai_caipin_manage();
			if (row != null)
			{
