...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_sjb_bisai
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_sjb_bisai model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_sjb_bisai model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_sjb_bisai GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_sjb_bisai model=new MxWeiXinPF.Model.wx_sjb_bisai();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_sjb_bisai DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_sjb_bisai model=new MxWeiXinPF.Model.wx_sjb_bisai();
			if (row != null)
			{
