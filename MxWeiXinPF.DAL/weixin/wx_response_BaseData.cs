...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_response_BaseData
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MxWeiXinPF.Model.wx_response_BaseData model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MxWeiXinPF.Model.wx_response_BaseData model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_response_BaseData GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_response_BaseData model=new MxWeiXinPF.Model.wx_response_BaseData();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_response_BaseData DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_response_BaseData model=new MxWeiXinPF.Model.wx_response_BaseData();
			if (row != null)
			{
