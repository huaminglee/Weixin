...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_requestRuleContent
	{
		...
		public MxWeiXinPF.Model.wx_requestRuleContent GetModel(int id)
		{
			...
			MxWeiXinPF.Model.wx_requestRuleContent model=new MxWeiXinPF.Model.wx_requestRuleContent();
		...
		/// 得到一个对象实体
		/// </summary>
		public MxWeiXinPF.Model.wx_requestRuleContent DataRowToModel(DataRow row)
		{
			MxWeiXinPF.Model.wx_requestRuleContent model=new MxWeiXinPF.Model.wx_requestRuleContent();
			if (row != null)
			{
        ...
        {
            IList<MxWeiXinPF.Model.wx_requestRuleContent> rcList = new List<Model.wx_requestRuleContent>();
            ...
            while (sr.Read())
            {
                model = new MxWeiXinPF.Model.wx_requestRuleContent();
                model.rContent = sr["rContent"].ToString();
                model.rContent2 = sr["rContent2"].ToString();
