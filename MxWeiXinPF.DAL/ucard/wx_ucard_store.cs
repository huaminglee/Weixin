...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_ucard_store
	{
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(MxWeiXinPF.Model.wx_ucard_store model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(MxWeiXinPF.Model.wx_ucard_store model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MxWeiXinPF.Model.wx_ucard_store DataRowToModel(DataRow row)
        {
            MxWeiXinPF.Model.wx_ucard_store model = new MxWeiXinPF.Model.wx_ucard_store();
            if (row != null)
            {
