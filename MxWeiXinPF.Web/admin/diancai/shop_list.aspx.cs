...
namespace MxWeiXinPF.Web.admin.diancai
{
    public partial class shop_list : Web.UI.ManagePage
    {
        ...
        BLL.wx_diancai_shopinfo gbll = new BLL.wx_diancai_shopinfo();
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and  hotelName like  '%" + _keywords + "%' ");
            }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("shop_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("shop_list_page_size", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("shop_list.aspx", "keywords={0}", this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("shop_list.aspx", "keywords={0}", this.keywords), "Success");
        }
