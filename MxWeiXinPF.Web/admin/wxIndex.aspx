<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxIndex.aspx.cs" Inherits="MxWeiXinPF.Web.admin.wxIndex" %>
                ...
                <div class="nav-right">
                    <div class="icon-info">
                        <span>您好，<%=admin_info.user_name %><br />
                            <%=new MxWeiXinPF.BLL.manager_role().GetTitle(admin_info.role_id) %>
                        </span>
                    </div>
