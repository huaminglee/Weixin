...
{
    public partial class ggkAwardUser : Web.UI.ManagePage
    {
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("ggkAwardUser_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("ggkAwardUser.aspx?id=" + MyCommFun.RequestInt("id"), "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("ggkAwardUser.aspx?id=" + MyCommFun.RequestInt("id"), "keywords={0}", this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("ggkAwardUser.aspx?id=" + MyCommFun.RequestInt("id"), "keywords={0}", this.keywords), "Success");
        }
